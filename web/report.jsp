...
<html>
    ...
    <body>
        ...
        <form action="ControllerServlet" method="post">
            ...
            <input type="text" id="year" name="year" size="6" value="<%=session.getAttribute("year")%>" <%= (2+2==5) ? "readonly" : ""%>><br>
            ...
            <label for="usage">Hvad bruges/har bygningen været brugt til?&#160</label>
                   <input type="text" id="usage" name="usage" size="35" value="<%=request.getParameter("usage") != null ? request.getParameter("usage") : ""%>"><br><br><br>
